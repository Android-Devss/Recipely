...
class RecipeDetailsFragment : BaseFragment<FragmentRecipeDetailsBinding>() {
    ...
    private fun displayRecipeDetails(recipeId: Int) {
        ...
        binding?.recipeDetailsName?.text = recipe.recipeName
        binding?.recipeDetailsIngredients?.text = recipe.ingredients
        binding?.recipeDetailsTime?.text = recipe.totalTimeInMinutes.toString()
        binding?.recipeDetailsCuisine?.text = recipe.cuisine
        binding?.recipeDetailsHealthIngredients?.text = recipe.cleanedIngredients
